...
```{r setup-1, include=FALSE, results="hide", warning=FALSE}
require(knitr)
opts_chunk$set(fig.width = 12, # originally 12
               fig.height = 6, # originally 6
               dpi = 300,
